...
public class ERExaminationAngiographyRoom extends Agent
{
	private static final long serialVersionUID = -2280826609228507294L;

	ERPatientAgent erCurrentPatientAgent;								// 現在対応している患者
	ArrayList<ERClinicalEngineerAgent> ArrayListClinicalEngineerAgents;	// 現在所属している医療技師エージェント
	ERClinicalEngineerAgent erCurrentClinicalEngineerAgent;				// 担当している医療技師エージェント
	int iAttachedClinicalEngineerNum;
	double lfTotalTime;
	private Logger cAngiographyRoomLog;									// ログ出力
	Rand rnd;															// 乱数クラス
	...
	private Object csAngiographyRoomCriticalSection;					// クリティカルセクション用
	 ...
	 * @since 2015/08/07
	 */
	public ERExaminationAngiographyRoom()
	{
		vInitialize();
	}
	 ...
	 * @since 2015/08/07
	 */
	public ERExaminationAngiographyRoom( int iAttachedClinicalEngineerNumData )
	{
...
//		rnd = new Sfmt( (int)seed );
	...
	public synchronized void vTerminate() throws IOException
	{
		...
		// 患者エージェントの終了処理を行います。
		synchronized( csAngiographyRoomCriticalSection )
		{
			...
			// ログ出力
			cAngiographyRoomLog = null;									// 血管造影室ログ出力設定
...
//			ArrayListClinicalEngineerAgents.get(i).vSetExaminationTime( alfExaminationTime[i] );
	 ...
	 * @throws ERClinicalEngineerAgentException			医療技師エージェントの例外クラス
	 * @author kobayashi
	 * @since 2015/08/04
	 */
	public void vImplementExaminationRoom( ArrayList<EREmergencyRoom> ArrayListEmergencyRooms, ArrayList<ERSevereInjuryObservationRoom> ArrayListSereveInjuryObservationRooms, ArrayList<ERConsultationRoom> ArrayListConsultationRooms, ArrayList<EROperationRoom> ArrayListOperationRooms, ERWaitingRoom erWaitingRoom ) throws ERClinicalEngineerAgentException
	{
		synchronized( csAngiographyRoomCriticalSection )
		{
			...
			if( erCurrentPatientAgent != null )
			{
				cAngiographyRoomLog.info(erCurrentPatientAgent.getId() + "," + "検査室対応中" );
	 ...
	 * @param ArrayListOperationRooms					全手術室
	 * @param erWaitingRoom								待合室
	 * @param erClinicalEngineerAgent					担当する医療技師エージェント
	 * @param erPatientAgent							検査を受検する患者エージェント
	 * @throws ERClinicalEngineerAgentException			医療技師エージェントの例外クラス
	 * @author kobayashi
	 * @since 2015/08/04
	 */
	private void vImplementExamination( ArrayList<EREmergencyRoom> ArrayListEmergencyRooms, ArrayList<ERSevereInjuryObservationRoom> ArrayListSereveInjuryObservationRooms, ArrayList<ERConsultationRoom> ArrayListConsultationRooms, ArrayList<EROperationRoom> ArrayListOperationRooms, ERWaitingRoom erWaitingRoom, ERClinicalEngineerAgent erClinicalEngineerAgent, ERPatientAgent erPatientAgent ) throws ERClinicalEngineerAgentException
	{
		// 医療技師エージェントの対応を実施します。
		erClinicalEngineerAgent.vSetAttending( 1 );

		if( erPatientAgent.isMoveWaitingTime() == false )
		{
			// 移動時間がまだ終了していないので、移動を実施しません。
			erClinicalEngineerAgent.vSetPatientMoveWaitFlag( 1 );
			cAngiographyRoomLog.info("血管造影室移動時間：" + erCurrentPatientAgent.lfGetMoveWaitingTime() );
			return;
		}
	 ...
	 * </PRE>
	 * @param ArrayListEmergencyRooms					全初療室
	 * @param ArrayListSereveInjuryObservationRooms		重症観察室
	 * @param ArrayListConsultationRooms				全診察室
	 * @param ArrayListOperationRooms					全手術室
	 * @param erWaitingRoom								待合室
	 * @param erClinicalEngineerAgent					担当した医療技師エージェント
	 * @param erPatientAgent							受検した患者エージェント
	 * @throws ERClinicalEngineerAgentException			医療技師エージェントの例外クラス
	 * @author kobayashi
	 * @since 2015/08/04
	 */
	private void vExaminationProcess( ArrayList<EREmergencyRoom> ArrayListEmergencyRooms, ArrayList<ERSevereInjuryObservationRoom> ArrayListSereveInjuryObservationRooms, ArrayList<ERConsultationRoom> ArrayListConsultationRooms, ArrayList<EROperationRoom> ArrayListOperationRooms, ERWaitingRoom erWaitingRoom, ERClinicalEngineerAgent erClinicalEngineerAgent, ERPatientAgent erPatientAgent ) throws ERClinicalEngineerAgentException
	{
		double lfExaminationTime;
		// 血管造影室にいる医療技師エージェントの数及び連携度を算出します。
...
//		if( erClinicalEngineerAgent.lfGetExaminationTime() > erClinicalEngineerAgent.lfGetCurrentPassOverTime() )
		...
		{
			// 何もせずに終了します。
			cAngiographyRoomLog.info( erPatientAgent.getId() + "," + erClinicalEngineerAgent.getId() + "," + "検査時間：" + erClinicalEngineerAgent.lfGetExaminationTime() );
			cAngiographyRoomLog.info( erPatientAgent.getId() + "," + erClinicalEngineerAgent.getId() + "," + "対応時間：" + erClinicalEngineerAgent.lfGetCurrentPassOverTime() );
			return ;
		}
		erClinicalEngineerAgent.vImplementExamination( erPatientAgent, 5 );
		cAngiographyRoomLog.info( erPatientAgent.getId() + "," + erClinicalEngineerAgent.getId() + "," + "血管造影検査終了" );
		...
		{
			cAngiographyRoomLog.info( erPatientAgent.getId() + "," + erClinicalEngineerAgent.getId() + "," + "診察室からの依頼です。診察室へ移動します。" + "," + "血管造影室" );
		...
		{
			cAngiographyRoomLog.info( erPatientAgent.getId() + "," + erClinicalEngineerAgent.getId() + "," + "手術室からの依頼です。診察室へ移動します。" + "," + "血管造影室" );
		...
		{
			cAngiographyRoomLog.info( erPatientAgent.getId() + "," + erClinicalEngineerAgent.getId() + "," + "初療室からの依頼です。診察室へ移動します。" + "," + "血管造影室" );
	 ...
	 * @throws ERClinicalEngineerAgentException	担当した医療技師エージェントの例外クラス
	 * @author kobayashi
	 * @since 2015/08/04
	 */
	private void vJudgeMoveConsultationRoom( ArrayList<ERConsultationRoom> ArrayListConsultationRooms, ERWaitingRoom erWaitingRoom, ERClinicalEngineerAgent erClinicalEngineerAgent, ERPatientAgent erPAgent  ) throws ERClinicalEngineerAgentException
	{
		...
		for( i = 0;i < ArrayListConsultationRooms.size(); i++ )
		{
			...
			{
				cAngiographyRoomLog.info( erPAgent.getId() + "," + erClinicalEngineerAgent.getId() + "," + "診察室へ移動準備開始" + "," + "血管造影室" );
				// 診察室待機フラグをOFFにします。
			...
			// 看護師、および医師エージェントにメッセージを送信します。
				...
				cAngiographyRoomLog.info( erPAgent.getId() + "," + erClinicalEngineerAgent.getId() + "," + "診察室へ移動準備終了" + "," + "血管造影室" );
				if( iInverseSimFlag == 1 )
				{
					...
					cAngiographyRoomLog.info( erPAgent.getId() + "," + erClinicalEngineerAgent.getId() + "," + "診察室へ移動開始" + "," + "血管造影室" );
				}
				erPAgent = null;
...
//				ArrayListConsultationRooms.get(i).cGetDoctorAgent().vSetConsultation(1);
	...
	private void vJudgeMoveOperationRoom( ArrayList<EROperationRoom> ArrayListOperationRooms, ERWaitingRoom erWaitingRoom, ERClinicalEngineerAgent erClinicalEngineerAgent, ERPatientAgent erPAgent )
	{
		...
		for( i = 0;i < ArrayListOperationRooms.size(); i++ )
		{
			...
			{
				cAngiographyRoomLog.info( erPAgent.getId() + "," + erClinicalEngineerAgent.getId() + "," + "手術室へ移動準備開始" + "," + "血管造影室" );
				// 手術室待ちフラグをOFFにします。
				...
				cAngiographyRoomLog.info( erPAgent.getId() + "," + erClinicalEngineerAgent.getId() + "," + "手術室へ移動準備終了" + "," + "血管造影室" );
				if( iInverseSimFlag == 1 )
				{
					// 移動先の経路を患者エージェントに設定します。
					erPAgent.vSetMoveRoute( erTriageNodeManager.getRoute( this.erGetTriageNode(), ArrayListOperationRooms.get(i).erGetTriageNode() ) );
					cAngiographyRoomLog.info( erPAgent.getId() + "," + erClinicalEngineerAgent.getId() + "," + "手術室へ移動開始" + "," + "血管造影室" );
				}
				erPAgent = null;
...
//		ERClinicalEngineerAgent erEmergencyclinicalEngineerAgent;
		for( i = 0;i < ArrayListEmergencyRooms.size(); i++ )
		{
			...
			{
				cAngiographyRoomLog.info( erPAgent.getId() + "," + erClinicalEngineerAgent.getId() + "," + "初療室へ移動準備開始" + "," + "血管造影室" );
				// 初療室待ちフラグをOFFにします。
...
//				}
				...
				cAngiographyRoomLog.info( erPAgent.getId() + "," + erClinicalEngineerAgent.getId() + "," + "初療室へ移動準備終了" + "," + "血管造影室" );
				if( iInverseSimFlag == 1 )
				{
					// 移動先の経路を患者エージェントに設定します。
					erPAgent.vSetMoveRoute( erTriageNodeManager.getRoute( this.erGetTriageNode(), ArrayListEmergencyRooms.get(i).erGetTriageNode() ) );
					cAngiographyRoomLog.info( erPAgent.getId() + "," + erClinicalEngineerAgent.getId() + "," + "初療室へ移動開始" + "," + "血管造影室" );
				}
				erPAgent = null;
	...
	private void vJudgeMoveSereveInjuryObservationRoom( ArrayList<ERSevereInjuryObservationRoom> ArrayListSereveInjuryObservationRooms, ERWaitingRoom erWaitingRoom, ERClinicalEngineerAgent erClinicalEngineerAgent, ERPatientAgent erPAgent  )
	{
		...
		for( i = 0;i < ArrayListSereveInjuryObservationRooms.size(); i++ )
		{
			...
			{
				cAngiographyRoomLog.info( erPAgent.getId() + "," + erClinicalEngineerAgent.getId() + "," + "重症観察室へ移動準備開始" + "," + "血管造影室" );
				// 重傷観察室待機フラグをOFFにします。
				...
				cAngiographyRoomLog.info( erPAgent.getId() + "," + erClinicalEngineerAgent.getId() + "," + "重症観察室へ移動準備終了" + "," + "血管造影室" );
				if( iInverseSimFlag == 1 )
				{
				// 移動先の経路を患者エージェントに設定します。
					...
					cAngiographyRoomLog.info( erPAgent.getId() + "," + erClinicalEngineerAgent.getId() + "," + "重症観察室へ移動開始" + "," + "血管造影室" );
				}
				erPAgent = null;
	...
	private void vJudgeMoveWaitingRoom( ERWaitingRoom erWaitingRoom, ERClinicalEngineerAgent erClinicalEngineerAgent, ERPatientAgent erPAgent )
	{
		...
		{
			cAngiographyRoomLog.info( erPAgent.getId() + "," + erClinicalEngineerAgent.getId() + "," + "待合室へ移動準備開始" + "," + "血管造影室" );
			// 患者エージェントを待合室に配置します。
			...
			cAngiographyRoomLog.info( erPAgent.getId() + "," + erClinicalEngineerAgent.getId() + "," + "待合室へ移動準備終了" + "," + "血管造影室" );
			if( iInverseSimFlag == 1 )
			{
				// 移動先の経路を患者エージェントに設定します。
				erPAgent.vSetMoveRoute( erTriageNodeManager.getRoute( this.erGetTriageNode(), erWaitingRoom.erGetTriageNode() ) );
				cAngiographyRoomLog.info( erPAgent.getId() + "," + erClinicalEngineerAgent.getId() + "," + "待合室へ移動開始" + "," + "血管造影室" );
			}
			erPAgent = null;
		}
		else
	 ...
	 * </PRE>
	 * @param erPAgent	登録されている患者エージェント
	 * @author kobayashi
	 * @since 2015/08/05
	 */
	...
	/**
	 * <PRE>
	 *    現在検査を行っている医療技師エージェントのインスタンスを取得します。
	 * </PRE>
	 * @return	担当医療技師エージェントインスタンス
	 */
	...
	/**
	 * <PRE>
	 *    現在選択されている血管造影室のノードを取得します。
	 * </PRE>
	 * @return	選択中の血管造影室のノード
	 */
	 ...
	 *   血管造影室のノードを設定します。
	 * </PRE>
	 * @param erNode	設定するノードインスタンス(血管造影室)
	 */
	 ...
	 *    現時点で患者がいるかどうかを取得します。
	 * </PRE>
	 * @return	受検中の患者エージェントがいる場合は1を返却、そうでない場合は0を返却。
	 */
	...
	{
		// TODO 自動生成されたメソッド・スタブ
		csAngiographyRoomCriticalSection = cs;
	}
	 ...
	 *   乱数を設定します。
	 * </PRE>
	 * @param sfmtRandom	メルセンヌツイスター用インスタンス
	 */
	...
	/**
	 * <PRE>
	 *   血管造影室の患者エージェントの数を取得します。
	 *   nullでなければ1人いるので1と返却します。
	 * </PRE>
	 * @return	1 患者が存在 0 いない
	 * @author kobayashi
	 * @since 2016/07/27
	 */
	...
	/**
	 * <PRE>
	 *    最後に病床に入った患者の在院時間を取得します。
	 * </PRE>
	 * @return	最後に病床に入った患者の在院時間
	 */
	...
	/**
	 * <PRE>
	 *    最後に病床に入った患者の到着から入院までの時間を取得します。
	 * </PRE>
	 * @return	最後に病床に入った患者の到着から入院までの時間
	 */
