...
//		rnd = new Sfmt( (int)seed );
	...
	public int iImplementWaitingRoom( ArrayList<ERConsultationRoom> ArrayListConsultationRooms,
									   ...
									   ArrayList<ERSevereInjuryObservationRoom>
									   ...
									   ArrayList<ERExaminationFastRoom> ArrayListExaminationFastRooms ) throws ERNurseAgentException
	{
		int i,j;
		int iEnableNurse;
		int iRes = 0;
...
//		engine.addAgent(ArrayListPatientAgents.get( ArrayListPatientAgents.size()-1));
	 ...
	 * @since 2015/08/07
	 */
	public void vArrivalPatient( double lfTime, SimulationEngine engine, int iRandomMode, int iInverseSimMode, int iFileWriteMode, int iDisasterFlag ) throws IOException
	{
		double lfProb1 = 0.0;
		double lfProb2 = 0.0;
