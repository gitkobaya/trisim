...
public class MessageFromPatToNurse implements Savable{
	...
	int iPatientLocation;				// 現在患者がいる部屋
	...
	int iSurvivalFlag;						// 患者が生存しているか否かを表すフラグ
	 ...
	 *    患者の今現在いる位置を設定します。
	 * </PRE>
	 * @param iPatientLocationData 患者の位置
	 * @author kobayashi
	 * @since 2015/07/29
	 * @version 0.1
	 */
	public void vSetPatientLocation( int iPatientLocationData )
	{
		iPatientLocation = iPatientLocationData;
	}
	 ...
	 * @version 0.1
	 */
	public void vSetAISUpperExtremity( double lfExamAISUpperExtremityData )
	{
	 ...
	 * @version 0.1
	 */
	public void vSetAISLowerExtremity( double lfExamAISLowerExtremityData )
	{
	 ...
	 * @version 0.1
	 */
	public void vSetAISUnspecified( double lfExamAISUnspecifiedData )
	{
	 ...
	 *    腹部AIS値を設定します。
	 * </PRE>
	 * @param strInjuryAbdomenDataStatus 腹部AIS値口頭内容
	 * @author kobayashi
	 * @since 2015/07/29
	 * @version 0.1
	 */
	public void vSetInjuryAbdomenStatus( String strInjuryAbdomenDataStatus )
	{
		strInjuryAbdomenStatus = strInjuryAbdomenDataStatus;
	}
	 ...
	 *    脊椎AIS値を設定します。
	 * </PRE>
	 * @param strInjurySpineDataStatus 脊椎AIS値口頭内容
	 * @author kobayashi
	 * @since 2015/07/29
	 * @version 0.1
	 */
	public void vSetInjurySpineStatus( String strInjurySpineDataStatus )
	{
		strInjurySpineStatus = strInjurySpineDataStatus;
	}
	 ...
	 *    上肢AIS値を設定します。
	 * </PRE>
	 * @param strInjuryUpperExtremityStatusData 上肢AIS値口頭内容
	 * @author kobayashi
	 * @since 2015/07/29
	 * @version 0.1
	 */
	public void vSetInjuryUpperExtremityStatus( String strInjuryUpperExtremityStatusData )
	{
		strInjuryUpperExtremityStatus = strInjuryUpperExtremityStatusData;
	}
	...
	/**
	 * <PRE>
	 *   体表、熱傷、その他外傷のAISを取得します。
	 * </PRE>
	 * @return 体表、熱傷、その他外傷のAISを返却。
	 * @author kobayashi
	 * @since 2015/07/29
	 * @version 0.1
	 */
