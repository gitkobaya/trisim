...
// エージェント間のメッセージ送信用に必要。
public class MessageFromEngToDoc implements Savable
{
	...
	MessageFromEngToDoc()
	{
		...
		lfExaminationTime			= 0;		// 診察に要した時間。
		iClinicalEngineerDepartment	= 0;		// 医師の担当部門
	 ...
	 *    医師が依頼する検査部位を設定します。
	 * </PRE>
	 * @param aiRequestAnatomysData	検査する部位
	 * @author kobayashi
	 * @since 2015/07/29
	 * @version 0.1
	 */
	 ...
	 * </PRE>
	 * @param iRequestExaminationNumData	検査対象の部位数
	 * @author kobayashi
	 * @since 2015/07/29
	 * @version 0.1
	 */
