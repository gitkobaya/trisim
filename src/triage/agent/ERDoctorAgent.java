...
//				if( rnd.NextUnif() < 0.78 )
				if( rnd.NextUnif() < initSimParam.lfGetDoctorImplementConsultationJudgeEmergencyDischargeRate1() )
					iProcessResult = 1;
			}
...
//					if( rnd.NextUnif() < 0.999 )
					if( rnd.NextUnif() < initSimParam.lfGetDoctorImplementConsultationJudgeGeneralWardDischargeRate1() )
						iProcessResult = 1;
				}
				else if( iEmergencyLevel == 5 && erPatientAgent.iGetStartEmergencyLevel() == 5 )
				{
					if( rnd.NextUnif() <= initSimParam.lfGetDoctorImplementConsultationJudgeGeneralWardDischargeRate2() )
						iProcessResult = 1;
				}
				else if( iEmergencyLevel == 5 && erPatientAgent.iGetStartEmergencyLevel() == 4 )
				{
					if( rnd.NextUnif() <= initSimParam.lfGetDoctorImplementConsultationJudgeGeneralWardDischargeRate3() )
						iProcessResult = 1;
				}
				else if( iEmergencyLevel == 4 && erPatientAgent.iGetStartEmergencyLevel() == 4 )
				{
//					if( rnd.NextUnif() < 0.8 )
					if( rnd.NextUnif() < initSimParam.lfGetDoctorImplementConsultationJudgeGeneralWardDischargeRate4() )
						iProcessResult = 1;
				}
			}
		}
...
//		lfRand = weibullRand(initSimParam.lfGetDoctorJudgeMildTraumaWeibullAlpha(), initSimParam.lfGetDoctorJudgeMildTraumaWeibullBeta());
//		lfPrevProb = initSimParam.lfGetDoctorJudgeMildTrauma3();
//		if( lfRand <= lfPrevProb )
//		{
//			iEmergency = 4;
//		}
//		lfCurProb = initSimParam.lfGetDoctorJudgeMildTrauma4();
...
//		lfCurProb += 0.5;
//		lfCurProb += initSimParam.lfGetDoctorJudgeMildTrauma5();
//		if( lfPrevProb <= lfRand && lfRand <= lfCurProb )
		{
			iEmergency = 5;
		}
...
//		lfRand = weibullRand(1.0, 0.05);		// 現在設定値
...
//		lfRand = 0.01 * normalRand() + 0.99;
		lfRand = weibullRand(initSimParam.lfGetDoctorJudgeModerateTraumaWeibullAlpha(), initSimParam.lfGetDoctorJudgeModerateTraumaWeibullBeta());
		if( lfRand <= lfPrevProb )
		{
			iEmergency = 3;
		}
		lfCurProb = initSimParam.lfGetDoctorJudgeModerateTrauma3();
		if( lfPrevProb <= lfRand && lfRand <= lfCurProb )
		{
			iEmergency = 3;
		}
		lfPrevProb = lfCurProb;
//		lfCurProb += 0.5;
		lfCurProb += initSimParam.lfGetDoctorJudgeModerateTrauma4();
		if( lfPrevProb <= lfRand && lfRand <= lfCurProb )
		{
			iEmergency = 4;
		}
		lfPrevProb = lfCurProb;
//		lfCurProb += 0.25;
		lfCurProb += initSimParam.lfGetDoctorJudgeModerateTrauma5();
		if( lfPrevProb <= lfRand && lfRand <= lfCurProb )
		{
			iEmergency = 5;
		}
...
//		lfRand = weibullRand(2.0, 1.1);
		lfRand = weibullRand(initSimParam.lfGetDoctorJudgeSevereTraumaWeibullAlpha(), initSimParam.lfGetDoctorJudgeSevereTraumaWeibullBeta());
		if( lfRand <= lfPrevProb )
		{
			iEmergency = 2;
		}
		lfCurProb = initSimParam.lfGetDoctorJudgeSevereTrauma2();
		if( lfPrevProb <= lfRand && lfRand <= lfCurProb )
		{
			iEmergency = 2;
		}
		lfPrevProb = lfCurProb;
//		lfCurProb += 0.5;
		lfCurProb += initSimParam.lfGetDoctorJudgeSevereTrauma3();
		if( lfPrevProb <= lfRand && lfRand <= lfCurProb )
		{
			iEmergency = 3;
		}
		lfPrevProb = lfCurProb;
//		lfCurProb += 0.25;
		lfCurProb += initSimParam.lfGetDoctorJudgeSevereTrauma4();
		if( lfPrevProb <= lfRand && lfRand <= lfCurProb )
		{
			iEmergency = 4;
		}
